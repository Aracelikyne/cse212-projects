...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The PersonQueue class was implementing a Stack (LIFO) instead of a Queue (FIFO), causing people to come out in the wrong order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The person with no turns was incorrectly removed from the queue instead of being re-added.
    ...
    // Defect(s) Found: The person with negative turns was incorrectly removed from the queue instead of being re-added.
